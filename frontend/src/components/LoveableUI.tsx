      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 text-lg group">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-6 border">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="bg-gray-50 hover:bg-gray-100 rounded-lg p-3 text-sm font-medium text-gray-800 transition-colors cursor-pointer">
                    {link}
                  </div>
                ))}
              </div>
